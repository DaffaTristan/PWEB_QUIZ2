<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="PWEB_quiz2.Signup" %>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                <form class="container-form text-white" runat="server">
                    <h2 class="text-center">Form Sign Up</h2>
                  <div class="top-buffer form-group">
                    <label class="text-white" for="exampleInputName1">Name</label>
                  ...
                  <div class="top-buffer form-group">
                    ...
                    <asp:Button ID="BtnSignup" OnClick="BtnSignup_Click" CssClass="top-buffer btn btn-outline-danger col-12 mt-4" runat="server" Text="Sign Up" />
                    <asp:Button ID="BtnLogin" OnClick="BtnLogin_Click" CssClass="top-buffer btn btn-warning col-12 mt-4" runat="server" Text="Log In"/>
